...
public class ErrorCode {
    ...
    static final public int MRM_ERR_VCIL_DATA_NOT_READY                                  = 0x03000009;
    static final public int MRM_ERR_VCIL_CAN_FILTER_NOT_ENABLE                           = 0x03000010;
    ...
    static public String errorCodeToString(int errorCode) {
        ...
        } else if(errorCode == MRM_ERR_VCIL_CAN_FILTER_NOT_ENABLE) {
            return String.format("FILTER NOT ENABLE");
